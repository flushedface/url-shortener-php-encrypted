...
<head lang="en">
    ...
    <meta id="session" content=<?php echo session_id(); ?> >
...
<center>
    ...
    <div class="section group">
        <div class="col span_3_of_3">
                <input type="url" id="input" class="input" placeholder="Enter a URL or Text here"> <!-- window.c.encrypt( document.getElementById('input'), document.getElementById('cinput'), false ) /-->
        </div>
    </div>
